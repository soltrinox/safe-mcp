# SAFE-T1008: Tool Shadowing Attack - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1008: Tool Shadowing Attack** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify tool shadowing attack indicators in MCP environments.
...
```bash
python3 detector.py safe-t1008_attack_logs.json
```
