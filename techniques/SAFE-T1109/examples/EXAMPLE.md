# SAFE-T1109: Debugging Tool Exploitation - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1109: Debugging Tool Exploitation** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify debugging tool exploitation indicators in MCP environments.
...
```bash
python3 detector.py safe-t1109_attack_logs.json
```
