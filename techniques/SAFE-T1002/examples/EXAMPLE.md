# SAFE-T1002: Supply Chain Compromise - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1002: Supply Chain Compromise** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify supply chain compromise indicators in MCP environments.
...
```bash
python3 detector.py safe-t1002_attack_logs.json
```
