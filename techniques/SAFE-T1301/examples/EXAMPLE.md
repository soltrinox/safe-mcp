# SAFE-T1301: Cross-Server Tool Shadowing - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1301: Cross-Server Tool Shadowing** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify cross-server tool shadowing indicators in MCP environments.
...
```bash
python3 detector.py safe-t1301_attack_logs.json
```
