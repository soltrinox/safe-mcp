# SAFE-T1501: Full-Schema Poisoning (FSP) - Attack Pseudocode

## Overview
This file contains pseudocode examples demonstrating how Full-Schema Poisoning (FSP) attacks
...
```python
# Example attack pseudocode for Full-Schema Poisoning (FSP)

def perform_attack():
    """
    Pseudocode demonstrating Full-Schema Poisoning (FSP) attack flow
    """
    ...
    malicious_payload = craft_payload(
        technique="Full-Schema Poisoning (FSP)",
...
def generate_malicious_arguments(technique):
    ...
    """
    if technique == "Full-Schema Poisoning (FSP)":
        return {
...
def detect_attack(session, tool_call):
    """
    Detect Full-Schema Poisoning (FSP) attack attempts
    """
    
    # Check for suspicious patterns
    if contains_suspicious_patterns(tool_call):
        log_security_event(
            event_type="SAFE-T1501",
            session=session,
            tool_call=tool_call
        )
        return True
