# SAFE-T1307: Confused Deputy Attack - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1307: Confused Deputy Attack** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify confused deputy attack indicators in MCP environments.
...
```bash
python3 detector.py safe-t1307_attack_logs.json
```
