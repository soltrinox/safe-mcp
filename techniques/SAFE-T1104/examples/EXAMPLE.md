# SAFE-T1104: Over-Privileged Tool Abuse - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1104: Over-Privileged Tool Abuse** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify over-privileged tool abuse indicators in MCP environments.
...
```bash
python3 detector.py safe-t1104_attack_logs.json
```
