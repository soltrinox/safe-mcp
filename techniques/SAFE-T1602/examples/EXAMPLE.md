# SAFE-T1602: Tool Enumeration - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1602: Tool Enumeration** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify tool enumeration indicators in MCP environments.
...
```bash
python3 detector.py safe-t1602_attack_logs.json
```
