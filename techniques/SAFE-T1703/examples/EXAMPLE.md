# SAFE-T1703: Tool-Chaining Pivot - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1703: Tool-Chaining Pivot** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify tool-chaining pivot indicators in MCP environments.
...
```bash
python3 detector.py safe-t1703_attack_logs.json
```
