# SAFE-T1106: Autonomous Loop Exploit - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1106: Autonomous Loop Exploit** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify autonomous loop exploit indicators in MCP environments.
...
```bash
python3 detector.py safe-t1106_attack_logs.json
```
