# SAFE-T1201: MCP Rug Pull Attack - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1201: MCP Rug Pull Attack** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify mcp rug pull attack indicators in MCP environments.
...
```bash
python3 detector.py safe-t1201_attack_logs.json
```
