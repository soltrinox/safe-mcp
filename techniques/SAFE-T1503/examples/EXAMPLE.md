# SAFE-T1503: Env-Var Scraping - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1503: Env-Var Scraping** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify env-var scraping indicators in MCP environments.
...
```bash
python3 detector.py safe-t1503_attack_logs.json
```
