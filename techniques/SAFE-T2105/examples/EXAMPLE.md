# SAFE-T2105: Disinformation Output - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T2105: Disinformation Output** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify disinformation output indicators in MCP environments.
...
```bash
python3 detector.py safe-t2105_attack_logs.json
```
