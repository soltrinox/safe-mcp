# SAFE-T1904: Chat-Based Backchannel - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1904: Chat-Based Backchannel** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify chat-based backchannel indicators in MCP environments.
...
```bash
python3 detector.py safe-t1904_attack_logs.json
```
