#!/usr/bin/env python3
"""
SAFE-T1101: Command Injection - Detection Implementation

This detector identifies indicators of command injection attacks in MCP environments.
...
class T1101Detector:
    """Detector for Command Injection attacks in MCP environments"""
    ...
    def scan(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        """Scan for command injection indicators"""
        findings = {
            'critical': [],
            'high': [],
            'medium': [],
    ...
    def scan_logs(self, log_file: str) -> Dict[str, Any]:
        """Scan log file for command injection indicators"""
        try:
    ...
    def generate_report(self, scan_results: Dict[str, Any]) -> str:
        ...
        report = f"\n=== SAFE-T1101 Detection Report ===\n\n"
        report += f"Technique: Command Injection\n"
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print(f"\nSAFE-T1101: Command Injection Detector")
