# SAFE-T1111: AI Agent CLI Weaponization - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1111: AI Agent CLI Weaponization** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify ai agent cli weaponization indicators in MCP environments.
...
```bash
python3 detector.py safe-t1111_attack_logs.json
```
