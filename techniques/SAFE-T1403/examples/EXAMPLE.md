# SAFE-T1403: Consent-Fatigue Exploit - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T1403: Consent-Fatigue Exploit** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify consent-fatigue exploit indicators in MCP environments.
...
```bash
python3 detector.py safe-t1403_attack_logs.json
```
