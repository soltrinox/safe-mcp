# SAFE-T3001: Unknown Technique - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T3001: Unknown Technique** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
The detector (`detector.py`) implements patterns from the Sigma detection rule to identify unknown technique indicators in MCP environments.
...
```bash
python3 detector.py safe-t3001_attack_logs.json
```
