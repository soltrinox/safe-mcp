# SAFE-T2101: Unknown Technique - Example Implementation

## Overview

This directory contains working examples demonstrating **SAFE-T2101: Unknown Technique** detection and attack simulation. These examples are generated from `pseudocode.md` and `detection-rule.yml`.
...
```bash
python3 detector.py safe-t2101_attack_logs.json
```
